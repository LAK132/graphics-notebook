...
\subsection{simple\_xlib}
\label{subsec:simple_xlib}
...
\subsection{blit\_xlib}
\label{subsec:blit_xlib}
...
\example{C}{blit_xlib.c}

% -----------------------------------------------------------------------------
% simple_xcb
% -----------------------------------------------------------------------------

\subsection{simple\_xcb}
\label{subsec:simple_xcb}
...
\subsection{blit\_direct\_xcb}
\label{subsec:blit_direct_xcb}
...
\example{C}{blit_direct_xcb.c}

% -----------------------------------------------------------------------------
% blit_pixmap_xcb
% -----------------------------------------------------------------------------

\subsection{blit\_pixmap\_xcb}
\label{subsec:blit_pixmap_xcb}
...
\example{C}{blit_pixmap_xcb.c}

% -----------------------------------------------------------------------------
% simple_wayland
% -----------------------------------------------------------------------------

\subsection{simple\_wayland}
\label{subsec:simple_wayland}
...
\subsection{simple\_win32}
\label{subsec:simple_win32}
